...
- **Verified sections:** Short-circuit assertions (||) anti-pattern (lines 183-206), game initialization conventions (lines 71-117), auto-start fixes verified for Snake, Tetris, and Breakout, auto-start regression fixes confirmed in Snake, Tetris, and Breakout.
- **Excluded:** None.
