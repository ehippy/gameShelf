...
- **Verified sections:** Short-circuit assertions (||) anti-pattern (lines 183-206), game initialization conventions (lines 71-117), auto-start fixes verified across Snake, Tetris, and Breakout. (Reviewed 2026-01-04)
- **Excluded:** None.
