...
- If a card completed cleanly (no revisions, no retries, no dead ends), **omit the struggles/friction section entirely** rather than writing boilerplate like "struggles: Nothing notable" or "friction: None."- When friction *did* occur, note the specific friction briefly — what went wrong, what you learned, and what to watch for next time.
