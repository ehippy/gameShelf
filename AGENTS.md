...
- **Verified sections:** Short-circuit assertions (||) anti-pattern (lines 183-206), game initialization conventions (lines 71-117). Auto-start regression confirmed fixed in Snake, Tetris, and Breakout.
- **Excluded:** None.
