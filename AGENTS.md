...
- **Verified sections:** Short-circuit assertions (||) anti-pattern (lines 183-206), game initialization conventions (lines 71-117), auto-start fixes verified (2026-01-04 card request)
- **Excluded:** None.

- **Auto-start regression:** Verified fixed in Snake, Tetris, and Breakout.
