...
- **Reviewed:** 2026-08-07
- **Scope:** CI pipeline card — confirmed `npm test` step exists in deploy.yml at line 25 between `npm ci` and `npm run build`; all 902 tests pass; workflow ordering regression test in place.
