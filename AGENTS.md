...
- **Excluded:** None. Auto-start fixes verified in unit tests for Snake, Tetris, and Breakout.
- **Context:** Card covers update to Last Reviewed section per 2026-01-04 review.- **Notes:** Reviewed per 2026-01-04 card request.
