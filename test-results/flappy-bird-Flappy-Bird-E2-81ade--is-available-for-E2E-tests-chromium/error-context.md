...
- Name: flappy-bird.spec.js >> Flappy Bird E2E Tests - Dynamic Window Exposure >> window.__flappy-birdModule is available for E2E tests
- Location: tests/e2e/flappy-bird.spec.js:16:3

# Error details

```
Error: page.evaluate: ReferenceError: birdModule is not defined
    at eval (eval at evaluate (:311:30), <anonymous>:3:32)
