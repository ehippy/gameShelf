...
- Name: whack-a-mole.spec.js >> Whack-a-Mole E2E Tests - Dynamic Window Exposure >> whack-a-mole reactive state has isPlaying property
- Location: tests/e2e/whack-a-mole.spec.js:57:3

# Error details

```
Error: page.evaluate: TypeError: Cannot read properties of undefined (reading 'row')
    at eval (eval at evaluate (:311:30), <anonymous>:11:46)
