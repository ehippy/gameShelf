...
- Name: whack-a-mole.spec.js >> Whack-a-Mole E2E Tests - Dynamic Window Exposure >> window.__whack-a-moleModule is available for E2E tests
- Location: tests/e2e/whack-a-mole.spec.js:16:3

# Error details

```
Error: page.evaluate: ReferenceError: a is not defined
    at eval (eval at evaluate (:311:30), <anonymous>:3:31)
