...
```
Error: page.evaluate: TypeError: Cannot read properties of null (reading 'shape')
    at Module.K (http://localhost:4173/assets/gameLogic-D_OEMdvl.js:1:2908)
    at eval (eval at evaluate (:311:30), <anonymous>:17:20)
