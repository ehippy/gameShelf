...
- Name: flappy-bird.spec.js >> Flappy Bird E2E Tests - Dynamic Window Exposure >> flappy-bird reactive state has isPlaying property
- Location: tests/e2e/flappy-bird.spec.js:57:3

# Error details

```
Error: page.evaluate: ReferenceError: birdReactiveState is not defined
    at eval (eval at evaluate (:311:30), <anonymous>:2:49)
