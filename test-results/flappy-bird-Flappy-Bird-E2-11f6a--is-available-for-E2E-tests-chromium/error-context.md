...
- Name: flappy-bird.spec.js >> Flappy Bird E2E Tests - Dynamic Window Exposure >> window.__flappy-birdReactiveState is available for E2E tests
- Location: tests/e2e/flappy-bird.spec.js:24:3
